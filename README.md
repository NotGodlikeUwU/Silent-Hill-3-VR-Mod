...
### Installing
You MUST install [Silent Hill 3 PC Fix by Steam006](https://community.pcgamingwiki.com/files/file/1331-silent-hill-3-pc-fix-by-steam006/) and [Silent Hill 3 Camera Mod](https://github.com/zealottormunds/sh3cammod). Install these mods and then just drop the contents of [Release](https://github.com/NotGodlikeUwU/Silent-Hill-3-VR-Mod/releases/tag/SH3VR) to the game directory. Then simply launch the game .exe
...
Basic experimental support for **ZealotTormunds First Person mod** is available.  
Roomscale is not yet implemented. Camera turning via controllers does not currently work with this mod — using keyboard + mouse is recommended for the best experience when the First Person mod is active.
