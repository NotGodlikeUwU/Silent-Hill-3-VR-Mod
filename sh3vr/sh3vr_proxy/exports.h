...
#if !defined(_M_IX86)
#error "sh3vr proxy must be built for Win32 (x86). sh3.exe is a 32-bit process."
#endif
...
#pragma comment(linker, "/export:DirectInput8Create=_DirectInput8Create@20,PRIVATE")